...
os.environ.setdefault("AUTHORIZED_K8S_USERS", "1")
os.environ.setdefault("AUTHORIZED_STAND_USERS", "1")
...
os.environ.setdefault("MM_BOT_TOKEN", "")
os.environ.setdefault("MM_SERVER_URL", "")
os.environ.setdefault("MM_WEBHOOK_PORT", "8065")
os.environ.setdefault("MM_WEBHOOK_HOST", "localhost")
os.environ.setdefault("MM_AUTHORIZED_MAIL_USERS", "")
os.environ.setdefault("MM_AUTHORIZED_DROPLET_USERS", "")
